...
public class TicketEncoderImpl extends TicketEncoder {
    ...
    public static boolean validateTicket(String encodedTicket) {
        ...
        try {
            ...
            if (ticketXmlHash.equals(decryptedTicketHash)) {
                ...
                if (decodedTicket.getValidDate().before(currentDate) && decodedTicket.getExpiryDate().after(currentDate)) {
                    return true;
                }
            }
        } catch (Exception ex) {
    ...
    public static Ticket decodeTicket(String encodedTicket) {
        try {
            ...
            throw new IllegalArgumentException("could not Decrypt Ticket: "+ encodedTicket);
        }
    }
}
