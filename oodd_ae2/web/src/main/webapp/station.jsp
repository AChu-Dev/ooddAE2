...
<%
    ...
    if ("createStation".equals(actionStr)) {
        ...
        if (stationName == null) {
            errorMessage = "stationName must be a parameter for addTicketMachine";
        } else {
            station = stationDAO.findByName(stationName);
            TicketMachine ticketMachine = new TicketMachine();
            UUID uuid = UUID.randomUUID();
            ticketMachine.setUuid(uuid.toString());
            ticketMachine.setStation(station);
            long id = new Random().nextLong();
            ticketMachine.setId(id);
            ticketMachineDAO.save(ticketMachine);
            message = "Created Ticket Machine: "+ uuid;
        }
...
<html>
    ...
    <body>
        ...
        <h2>Please wait for the page to refresh for results to appear</h2>
